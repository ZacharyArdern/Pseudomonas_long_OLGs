...
revcom0permlist=(unlist(distrib.permute$revcom.b.distrib0, use.names=FALSE))
cat("#revcom_0_permuted_seq_lengths", (revcom0permlist),"\n\n",sep="\t")

revcom0synlist=(unlist(distrib.synon$revcom.b.distrib0, use.names=FALSE))
cat("#revcom_0_synon_mutated_seq_lengths", (revcom0synlist),"\n\n",sep="\t")
